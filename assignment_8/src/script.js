...
jQuery (function() {
      ...
      <script>
        jQuery (function() {
          ...
          $(".pb-1").on("click", function() {
            let pb1 = '<div class = "pdf-file"><iframe class = "frames" src="media/p1-pb.pdf" style = "overflow: auto"></iframe></div>';
            $(".window-main-row").html(pb1);
            $(".back-button").css('visibility','visible');
          })
          $(".pb-2").on("click", function() {
            let pb2 = '<div class = "pdf-file"><iframe class = "frames" src="media/p2-pb.pdf" style = "overflow: auto"></iframe></div>';
            $(".window-main-row").html(pb2);
            $(".back-button").css('visibility','visible');
          })
          $(".pb-3").on("click", function() {
            let pb3 = '<div class = "pdf-file"><iframe class = "frames" src="media/p3-pb.pdf" style = "overflow: auto"></iframe></div>';
	...
	$("#coding-projects").on("click",function cp() {
        ...
        <div class="window-row" style = "padding: 0; padding-bottom: 52px">
          <div class="window-main-row">
            <div class = "pb pb-1" style = "object-fit: cover;">
              <img class = "pop-up-image" src = "images/battleship.PNG" alt = "Battleship Code">
              <h5 class = "pop-up-text">Play Battleship With R!</h5>
            </div>
            <div class = "pb pb-2">
              <img class = "pop-up-image" src = "images/R-logo.png" alt = "R Logo for Self-Written Package">
              <h5 class = "pop-up-text">Self-Written R Package</h5>
            </div>
          </div>
        </div>
      </div>
	...
	$("#about-me-button").on("click",function() {
		let am = `
		<div class = "about-me-labels">Resume</div>
    	<div class = "about-me-labels">Contact Me</div>
    	<div class = "about-me-labels">Random Facts!</div>
		`;
